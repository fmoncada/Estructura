...
public class SorterBigFileTemplateImplementationTesst {
    ...
    @Test
    public void dividir(){
        File inp = new File("entrada.txt");
        File oup = new  File("output.txt");
                SorterBigFileTemplateImpl sbfti=new SorterBigFileTemplateImpl(inp,4,oup);

                sbfti.breakFileInChunksAndSortIt(Ordenar2.PersonaNumDocu);
